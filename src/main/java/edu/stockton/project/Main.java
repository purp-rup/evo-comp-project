...
public class Main {
	public static void main(String[] args) throws IOException {
		...
		BufferedImage rawGraysale = VoronoiStippler.loadGrayscaleImage(inputImage);
		double[][] points = VoronoiStippler.stipple(rawGraysale);
		double[][] tour = TSPArtExample.generateTour(points);
		TSPArtExample.drawTour(tour, inputImage, new int[]{rawGraysale.getWidth(), rawGraysale.getHeight()});
	}
}
